...
class tft_DataGathering:
    ...
    def download_stocks(self):
        ...
        merged_df = all_dfs[0].rename(columns={'Date': 'date'}) if 'Date' in all_dfs[0].columns else all_dfs[0]
    ...
    def run(self):
        ...
        full_df = stock_df.merge(macro_df, left_index=True, right_index=True, how="left")
